...
#ifndef REACT_NATIVE_TURBO_IMAGE_PICKER_SWIFT_H
#define REACT_NATIVE_TURBO_IMAGE_PICKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="react_native_turbo_image_picker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
